...
def gen_fluxes_filter(cat, params): 
    ...
    # filter_list = params['filter_list'] #comment out by SF
    ## パラメータファイルのfilter_list = ['MIPS24', 'PACS70', 'PACS100', 'PACS160', 'SPIRE250', 'SPIRE350', 'SPIRE500', 'NIKA1200', 'NIKA2000']
    filter_list = ['NIKA1200', 'NIKA2000'] #added by SF　
    first_grid = True
